...
void setup()
{ 
  PhyphoxBLE::start("ESP32-Magnetometer-14");
  Serial.begin(9600);
...
void loop()
{
  ...
  float T_C[3][3]
  { { -7.32341840e-04, -3.27481874e-02,  2.07894176e+00},
    {    1.39695413e-03, -6.68557756e-01,  2.04655566e+01},
    { -1.00336774e-03, -2.89388527e-01,  1.02882381e+01 }
  };
  float Mxyz_final[3];
