...
void setup()
{ 
  PhyphoxBLE::start("ESP32-Magnetometer-2");
  Serial.begin(9600);
...
void loop()
{
  ...
  float T_C[3][3]
  { { -2.37944779e-04,  7.77412735e-02, -1.54935955e+00},
    {  2.09523028e-03, -7.76919674e-01,  1.68173632e+01},
    { -7.41018719e-04, -3.18939810e-01,  7.72918992e+00 }
  };
  float Mxyz_final[3];
