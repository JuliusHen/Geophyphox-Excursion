...
void setup()
{ 
  PhyphoxBLE::start("ESP32-Magnetometer-6");
  Serial.begin(9600);
...
void loop()
{
  ...
  float T_C[3][3]
  { { -2.52660671e-03,  3.03545950e-01, -6.06752519e+00},
    {    1.02874266e-03, -5.85238458e-01,  1.35574867e+01},
    { -7.16005840e-04, -2.97275069e-01,  7.63670151e+00 }
  };
  float Mxyz_final[3];

  float M_B[3]
  { 15.978022, -38.928294, 26.555508};

  float M_Ainv[3][3]
  { {  1.077193, -0.007092, 0.009235},
    { -0.007092 , 1.066695, -0.064453},
    { 0.009235, -0.064453, 1.078981}
  };
