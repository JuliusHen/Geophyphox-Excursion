...
void setup()
{ 
  PhyphoxBLE::start("Magnetometer-7");
  Serial.begin(9600);
...
void loop()
{
  ...
  float T_C[3][3]
  { { -1.30712020e-03,  1.86858054e-02,  2.00766867e-01},
    {    3.42054572e-04, -3.89752513e-01,  7.96833345e+00},
    { -1.30470580e-03, -1.81012298e-01,  5.35946484e+00 }
  };
  float Mxyz_final[3];
