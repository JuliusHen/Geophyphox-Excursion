...
void setup()
{ 
  PhyphoxBLE::start("Magnetometer-3");
  Serial.begin(9600);
...
void loop()
{
  ...
  float T_C[3][3]
  { {   -2.16545778e-03,  2.03949572e-01, -3.87051830e+00},
    {   -2.18183398e-03, -1.01076680e-01,  4.28346154e+00},
    {   -2.24857540e-03, -1.63650788e-01,  6.48485484e+00 }
  };
  float Mxyz_final[3];
