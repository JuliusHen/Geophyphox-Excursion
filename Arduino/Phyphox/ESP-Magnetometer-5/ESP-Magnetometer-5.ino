...
void setup()
{ 
  PhyphoxBLE::start("ESP32-Magnetometer-5");
  Serial.begin(9600);
...
void loop()
{
  ...
  float T_C[3][3]
  { { -2.63720047e-03,  2.30256612e-01, -3.94327963e+00},
    {    2.12523189e-03, -5.59917300e-01,  1.28545015e+01},
    { 2.82593583e-04, -3.30714272e-01,  8.19050686e+00 }
  };
  float Mxyz_final[3];

  float M_B[3]
  { 17.333402, -29.972805, 25.590086};

  float M_Ainv[3][3]
  { {  1.070510, -0.003625, -0.007293},
    { -0.003625, 1.060416, -0.073994},
    { -0.007293, -0.073994, 1.062230}
  };
