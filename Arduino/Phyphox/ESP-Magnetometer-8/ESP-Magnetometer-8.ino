...
void setup()
{ 
  PhyphoxBLE::start("ESP32-Magnetometer-8");
  Serial.begin(9600);
...
void loop()
{
  ...
  float T_C[3][3]
  { { -1.60305272e-03,  1.81750187e-01, -3.32712992e+00},
    {    1.20618281e-03, -5.10414880e-01,  1.05212705e+01},
    { -8.56495399e-04, -1.98148504e-01,  5.09997339e+00 }
  };
  float Mxyz_final[3];
